...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // FIXED: Added the corresponding User ID as the second parameter
        contService.adaugaCont(cc1, "U001");
        contService.adaugaCont(cc2, "U002");
        contService.adaugaCont(cc3, "U003");
        ...
        // FIXED: Added the corresponding User ID as the second parameter
        contService.adaugaCont(ce1, "U001");
        contService.adaugaCont(ce2, "U002");
